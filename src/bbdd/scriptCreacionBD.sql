...
INSERT INTO "Fridge" ("id","subscription","country","CCAA","municipality","street","number","CPP") VALUES (1,'Monthly','Spain','Madrid','Madrid','Gran Vía','123',28013),
...
INSERT INTO "Productos" ("id","nombre","descripción","stock","fecha","id_nevera") VALUES (1,'Leche','Leche fresca entera',50,'2023-03-17',1),
...
INSERT INTO "Notificaciones" ("id","nombre","tipo","descripción","fecha","id_nevera") VALUES (1,'Humedad anormal','Aviso','La humedad en la nevera es anormal','2023-03-17',1),
...
INSERT INTO "Humedad" ("id","fecha","valor","id_nevera") VALUES (1,'2022-01-01','70%',1),
 (2,'2022-01-02','68%',1),
 (3,'2022-01-03','72%',1),
 (4,'2022-01-04','71%',1),
 (5,'2022-01-05','69%',1),
 ...
 (19,'2022-01-09','81%',4),
 (20,'2022-01-10','82%',4);
INSERT INTO "Temperatura" ("id","fecha","valor","id_nevera") VALUES (1,'2022-01-01','20°C',1),
 (2,'2022-01-02','19°C',1),
 (3,'2022-01-03','22°C',1),
 (4,'2022-01-04','21°C',1),
 (5,'2022-01-05','18°C',1),
...
INSERT INTO "Puerta" ("id","fecha","valor","id_nevera") VALUES (1,'2022-01-01',1,1),
 (2,'2022-01-02',0,1),
 (3,'2022-01-03',1,1),
 (4,'2022-01-04',0,1),
 (5,'2022-01-05',1,1),
...
INSERT INTO "Subscribe" ("id_nevera","id_user") VALUES (1,1),
 ...
 (3,8),
 (4,8);
INSERT INTO "Usuarios" ("id","role","username","nombre","surname1","surname2","email","password","birthdate","credit_card","telephone_number") VALUES (1,'user','dani_','Daniel','Gutiérrez','Torres','gt104515gmail.com','dani10','1990-05-15',1234567890123456,673484600),
 ...
 (8,'técnico','pb','Pablo','Martinez','Valero','padaro@gmail.com.com','passwordstu','2002-03-03',1234567890123456,123456789);
